...
def check_play_button(ai_settings, screen, stats, play_button, ship, aliens, bullets, mouse_x, mouse_y, sb):
    ...
    if button_clicked and not stats.game_active:
        # 重置游戏设置
        ai_settings.initialize_dynamict_settings()
...
def update_bullets(ai_settings, screen, ship, aliens, bullets, sb, stats):
    ...
    check_bullet_alien_collisons(ai_settings, stats, screen, ship, aliens, bullets, sb)


def fire_bullet(ai_settings, screen, ship, bullets):
    """如果还没有达到限制，就发射一颗子弹"""
    # 创建一个子弹，并将其加入到bullets 组中
...
def check_bullet_alien_collisons(ai_settings, stats, screen, ship, aliens, bullets, sb):
    """响应子弹和敌人的碰撞"""
    # 删除发生碰撞的子弹和外星人
    # 检查是否有子弹击中了敌人
